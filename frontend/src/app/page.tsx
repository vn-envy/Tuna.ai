...
export default function Home() {
  ...
  const handleGoogleSignIn = () => {
    ...
    setTimeout(() => {
      // In a real app, Firebase sets an IndexedDB token and we get a JWT
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center bg-[#0a0f1a] text-white overflow-hidden relative">
      ...
      <div className="absolute top-[-20%] left-[-10%] w-[50%] h-[50%] bg-[#0ea5e9] rounded-full blur-[120px] opacity-20" />
      <div className="absolute bottom-[-20%] right-[-10%] w-[50%] h-[50%] bg-[#00d4aa] rounded-full blur-[120px] opacity-20" />
      ...
      <div className="z-10 flex flex-col items-center max-w-3xl text-center px-6">
        ...
        <button 
          ...
          className="flex items-center gap-3 px-8 py-4 bg-white text-[#0a0f1a] font-bold rounded-full text-lg shadow-[0_0_30px_rgba(255,255,255,0.2)] hover:shadow-[0_0_50px_rgba(255,255,255,0.4)] hover:scale-105 transition-all duration-300 disabled:opacity-70 disabled:hover:scale-100"
        >
